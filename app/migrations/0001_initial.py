    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('battery_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.Battery')),
                ('wheel_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.Wheel')),
            ],
        ),
        migrations.CreateModel(
            name='Tier_condition',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tier_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.Tire')),
                ('wheel_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.Wheel')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tier', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.Tire')),
                ('wheel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.Wheel')),
            ],
            options={
                'ordering': ['-id'],
            },
